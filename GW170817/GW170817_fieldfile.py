...
l = RADEC[0]/(180/np.pi)
b = (RADEC[1])/(180/np.pi)
F = (np.cos(decplot)*(raplot-l))**2 + (decplot-b)**2 - (RADIUS/(180/np.pi))**2
axins2.contour(raplot,decplot,F,[0], linewidths=2.0, colors = ['red'])
...
b = (RADEC[1])/(180/np.pi)
F = (np.cos(decplot)*(raplot-l))**2 + (decplot-b)**2 - (RADIUS/(180/np.pi))**2
axins2.contour(raplot,decplot,F,[0], linewidths=2.0, colors = ['blue'])
