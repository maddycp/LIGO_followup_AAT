...
filter_ra_dec_bigblock =  (df_result['RA'] >0.0) & (df_result['RA'] < 30) &  (df_result['DEC'] < -21.0) & (df_result['DEC'] > -28) 
...
ragrid = 240*3
decgrid = 120*3
ra = np.linspace(0,30,ragrid) 
dec =  np.linspace(-45,-15,decgrid)
...
#########################
RADECS = []
center_best = [(12.671631032953618, -24.884421650878146),
 (12.610304946188242, -24.819384599708698),
 (12.916935380015124, -25.209606906725387),
 (12.487652772657489, -24.624273446200352),
 (13.100913640311253, -25.404718060233733),
 (12.242348425595983, -24.364125241522558),
 (13.039587553545877, -25.46975511140318),
 (12.11969625206523, -24.299088190353107),
 (13.100913640311253, -25.534792162572632),
 (12.181022338830607, -24.16901408801421)]
